...
//        val filename = UUID.randomUUID().toString() //랜덤값 정의하기
//        val pdfref = FirebaseStorage.getInstance().getReference("/Uploads/$filename")
//        Log.d("fileREF", "Finally we saved the User to Firebase Database : $pdfref ")
//        val pdfFileUrl = pdfref.downloadUrl
//        Log.d("pdfFileUri", "Finally we saved the User to Firebase Database : $pdfFileUrl ")
